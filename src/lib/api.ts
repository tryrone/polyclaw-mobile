...
export type ConsumerAutoTradeProcedure = 'homeStatus' | 'copyConsent' | 'acceptCopyConsent' | 'configureAutoTradeLimits' | 'enableAutoTrade' | 'pauseAutoTrade' | 'resumeAutoTrade' | 'autoTradeTrades' | 'autoTradeTrade' | 'closeAutoTradePosition' | 'autoTradeWalletReadiness' | 'autoTradePerformance';
